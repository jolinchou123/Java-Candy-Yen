...
public class JavaFinal extends JFrame{
	...
	public JavaFinal()
	{
    	...
    	String stores[] = {"牛肉湯", "麻辣火鍋", "紅豆餅", "生魚片", "牛排", "鍋貼", 
    			"臭臭鍋", "雞排", "蔥抓餅", "ㄚMAN "};
    	String pictures[] = {"image/牛肉湯.jpg", "image/麻辣火鍋.jpg", "image/紅豆餅.jpg", "image/生魚片.jpg", "image/牛排.jpg", "image/鍋貼.jpg", 
    			"image/臭臭鍋.jpg", "image/雞排.jpg", "image/蔥抓餅.jpg", "image/早餐.jpg"};
	...
	public void setBack(){
        ...
        ImageIcon img = new ImageIcon("src/image/女朋友.jpg");
